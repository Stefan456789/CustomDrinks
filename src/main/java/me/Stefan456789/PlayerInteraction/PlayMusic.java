...
public class PlayMusic implements Listener {
    ...
    public void playerInteractEvent(PlayerInteractEvent e) {
        if (e.getAction().equals(Action.RIGHT_CLICK_BLOCK) && e.getClickedBlock().getBlockData().getMaterial().equals(Material.JUKEBOX)) {
            ...
            if (!jukebox.isPlaying() && e.getPlayer().getItemInHand().getItemMeta().getCustomModelData() != 0) {
